			...
			public void handleMessage(Message msg) {
				...
				case SMALLER_CAPTURE_FRAME:
					...
					if (capturedFrameBmp != null) {
						ivCapturedFrame.setBackgroundDrawable(new BitmapDrawable(capturedFrameBmp));
					}
				...
				case LARGER_CAPTURE_FRAME:
					...
					if (capturedFrameBmp != null) {
						ivCapturedFrame.setBackgroundDrawable(
								new BitmapDrawable(capturedFrameBmp));
					}
...
//				Rect marginRect = new Rect(0, 0, 0, 0);
//				resetCameraPreview(marginRect,
//						160, 110);
//				activity.sendBroadcast(intent);
	...
	public void resetCameraPreview(Rect marginRect, int width, int height) {
		...
		llParams.setMargins(marginRect.left, marginRect.top, marginRect.bottom,
				marginRect.right);
		svVideo.setLayoutParams(llParams);
		Log.e("test","VideoWidth"+svVideo.getWidth()+" VideoHeight "+svVideo.getHeight());
	}
